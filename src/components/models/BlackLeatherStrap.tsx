...
interface BlackLeatherStrapProps {
  [key: string]: any;
}

export function BlackLeatherStrap(props: BlackLeatherStrapProps) {
  const { nodes, materials } = useGLTF("/models/BlackLeatherBand.glb") as any;
  return (

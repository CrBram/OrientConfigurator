...
interface BurlingtonLeatherStrapProps {
  [key: string]: any;
}

export function BurlingtonLeatherStrap(props: BurlingtonLeatherStrapProps) {
  const { nodes } = useGLTF("/models/BurlingtonLeatherBand.glb") as any;
  return (
    <group {...props} dispose={null}>
      <mesh
        ...
        material={(nodes.Connector001 as Mesh).material}
      ...
      <mesh
        ...
        material={(nodes.ShortConnect001 as Mesh).material}
      ...
      <mesh
        ...
        material={(nodes.LongStrap002 as Mesh).material}
      ...
      <mesh
        ...
        material={(nodes.Cylinder002 as Mesh).material}
      ...
      <mesh
        ...
        material={(nodes.Cylinder003 as Mesh).material}
      ...
      <mesh
        ...
        material={(nodes.Pin as Mesh).material}
